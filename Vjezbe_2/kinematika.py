...
def jednoliko_gibanje(F,m,time,x_0=0,v_0=0):
    ...
    # Calculation of kinematic variables in 0.1 steps
    for i in range(time*10):
        a.append(F/m)
        t.append(0.1*i)
        v.append(v_0 + a[i]*t[i])
        x.append(x_0 + v[i]*t[i])
...
def kosi_hitac(v_0, theta, time, x_0=0, y_0=0):
